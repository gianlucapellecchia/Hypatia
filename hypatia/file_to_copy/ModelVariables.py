...
class ModelVariables():
    def __init__(self, model_data: ModelData):
        ...
        self.totalcost = self.calc_total_cost()        
    ...
    def _calc_actualized_emission(self):
        ...
        for reg in self.model_data.settings.regions:
            ...
            self.totalemission_allregions_act = self.totalemission_allregions_act + totalemission_regional_discounted
    
    def calc_total_cost(self):
        self.totalcost = cp.sum(self.totalcost_allregions_act, axis = 1) 