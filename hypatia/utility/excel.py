...
def read_settings(path: str, mode: ModelMode, optimization: ModelOptimization) -> ModelSettings:
    ...
    return ModelSettings(mode, optimization, global_settings, regional_settings)
