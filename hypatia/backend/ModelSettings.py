            ...
            connection_parameters_template.update(
                {
                    ...
                    "line_time_of_construction": {
                        "sheet_name": "Line_Time_of_construction",
                        "value": 1,
                        "index": pd.Index(
                            ["Line Time of construction"], name="Performance Parameter"
                        ),
                        "columns": indexer,
                    },
                    "interest_rate": {
                ...
                regional_parameters_template[reg].update(
                    {
                        ...
                        "time_of_construction": {
                            "sheet_name": "Time_of_construction",
                            "value": 1,
                            "index": pd.Index(
                                ["Time of construction"], name="Performance Parameter"
                            ),
                            "columns": indexer_reg,
                        },
                        "interest_rate": {
                ...
                regional_parameters_template[reg].update(
                    {
                        ...
                        "storage_charge_time": {
                            ...
                            "value": 1,
                            "index": pd.Index(["Charging Time of Storage in Hours"],name= "Performance Parameter"),
                            "columns": pd.Index(
                                self.technologies[reg]["Storage"], name="Technology"
                            ),
                        },
                        "storage_discharge_time": {
                            ...
                            "value": 1,
                            "index": pd.Index(["Discharging Time of Storage in Hours"],name= "Performance Parameter"),
                            "columns": pd.Index(
                                self.technologies[reg]["Storage"], name="Technology"
                            ),
                        },
            ...
            regional_parameters_template[reg].update(
                {
                    ...
                    "tech_availability": {
                        "sheet_name": "Tech_availability",
                        "value": 1,
                        "index": pd.Index(self.years, name="Years"),
                        "columns": indexer_reg,
                    },
                    "min_tech_capacity_factor": {
                        "sheet_name": "Min_capacity_factor_tech",
                        "value": 0,
                        "index": pd.Index(self.years, name="Years"),
                        "columns": indexer_reg,
                    },
                    "max_tech_capacity_factor": {
                        "sheet_name": "Max_capacity_factor_tech",
                        "value": 1,
                        "index": pd.Index(self.years, name="Years"),
                        "columns": indexer_reg,
                    },
                ...
                regional_parameters_template[reg].update(
                    {
                        ...
                        "Conv_plus_max_production": {
                                "sheet_name": "Max_production_Conv_plus",
                                "value": 1e20,
                                "index": pd.Index(self.years, name="Years"),
                                "columns": pd.MultiIndex.from_arrays(
                                    [take_technologyout_, take_carrierout_],
                        ...
                        "Conv_plus_min_production": {
                            "sheet_name": "Min_production_Conv_plus",
                            "value": 0,
                            "index": pd.Index(self.years, name="Years"),
                            "columns": pd.MultiIndex.from_arrays(
                                [take_technologyout_, take_carrierout_],
                        ...
                        "Conv_plus_max_production_share": {
                            "sheet_name": "Max_production_share_Conv_plus",
                            "value": 1,
                            "index": pd.Index(self.years, name="Years"),
                            "columns": pd.MultiIndex.from_arrays(
                                [take_technologyout_, take_carrierout_],
                        ...
                        "Conv_plus_min_production_share": {
                            "sheet_name": "Min_production_share_Conv_plus",
                            "value": 0,
                            "index": pd.Index(self.years, name="Years"),
                            "columns": pd.MultiIndex.from_arrays(
                                [take_technologyout_, take_carrierout_],
